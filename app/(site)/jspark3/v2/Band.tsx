...
/**
 * A within-start band as its two measured ends, or one value when they are the same.
 * Screen readers hear "lo to hi". Before the fill the band stays a marked placeholder.
 */
export default function Band({ lo, hi }: { lo: number | null; hi: number | null }) {
