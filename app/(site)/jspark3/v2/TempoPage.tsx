...
export default function TempoPage() {
  return <div className="tempo" id="tempo-top">
    ...
    <section className="tempo-shell tempo-install" id="install" aria-labelledby="install-title">
      <div><h2 id="install-title">Run Tempo</h2><p>Three DGX Sparks, a working RoCE fabric, and enough local storage. The install guide starts with a fit check.</p><p>Tempo downloads all its model files from <a href="https://huggingface.co/bot-lab-21/DeepSeek-V4.1-Flash-EXL3-3.5bpw-Pollard/tree/b60193e0609147553145d1538d935925f2763c1d">bot-lab-21’s DeepSeek release</a>, including the draft that helps generate answers faster. The official DeepSeek release named in our docs tells you where the model comes from; it is not another download. JSPARK3 Tempo on Hugging Face hosts the recipe, not model files.</p></div>
